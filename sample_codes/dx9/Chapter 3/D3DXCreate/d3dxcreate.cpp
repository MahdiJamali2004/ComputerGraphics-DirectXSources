...
bool Setup()
{
	...
	D3DXMatrixTranslation(&Worlds[1], -5.0f, 0.0f,  5.0f);
	D3DXMatrixTranslation(&Worlds[2],  5.0f, 0.0f,  5.0f);
	D3DXMatrixTranslation(&Worlds[3], -5.0f, 0.0f, -5.0f);
	D3DXMatrixTranslation(&Worlds[4],  5.0f, 0.0f, -5.0f);
